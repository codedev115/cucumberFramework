...
public class CheckOutPage {
	...
	@FindBy(how = How.CSS, using = "ul.wc_payment_methods")
	...
	public void scroll_topaymentMethod() {
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		jse.executeScript("arguments[0].scrollIntoView(true);", payment_method);
	}
	...
	public void fill_PersonalDetails(Customer customer) {
		...
		//select_County(customer.address.country);
